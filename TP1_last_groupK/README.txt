...
Para compilar deve usar makefile ou o comando:gcc mainP1.c table.c escrever.c ler.c -o main
para executar deve correr o programa como root, por causa da partilha de ficheiros. 
